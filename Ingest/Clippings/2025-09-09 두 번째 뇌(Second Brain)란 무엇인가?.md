...
두 번째 뇌는 생물학적 두뇌와 비슷한 **디지털 지식 관리 시스템**을 외부에 구축하는 것이다. 티아고 포르테가 만든 개인 지식 관리(PKM) 방법론으로, 현대 기술을 활용해 기억과 지성을 확장한다:

• **역사적 뿌리: 제텔카스텐** - 독일 사회학자 루만 교수가 A6 인덱스 카드로 90,000개의 메모를 연결하여 70권의 책과 400편의 논문을 발표했다. 하이퍼링크 원리를 활용해 카드 간 연결을 통해 창의적 아이디어를 창출했다.

• **필요성과 효과** - 노트 쓰기는 천재성을 끌어내는 효율적 방법이다. 다빈치, 뉴턴, 아인슈타인 등의 천재들도 노트 쓰기를 활용했으며, 마인드맵도 이들의 노트법에서 영감을 받았다.

• **핵심 원리 3가지** - ①하나의 노트에 하나의 아이디어(원자 노트) ②노트 간 연결을 통한 새로운 노트 창조 ③나만의 생각을 적어 수동적 소비에서 능동적 생산으로 전환.

두 번째 뇌는 단순한 도구가 아닌 자산 관리처럼 여러 요소가 통합된 분산 시스템이다. 지식을 모으고 정리하는 것보다 연결과 창조에 집중해야 한다.
